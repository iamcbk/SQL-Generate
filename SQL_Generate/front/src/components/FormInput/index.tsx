...
import { DownOutlined, PlusOutlined, UpOutlined, DatabaseOutlined, TableOutlined, InfoCircleOutlined, NumberOutlined, FieldBinaryOutlined, SaveOutlined, DeleteOutlined, ImportOutlined, AppstoreAddOutlined, CopyOutlined, ClearOutlined, ThunderboltOutlined } from '@ant-design/icons';
import {
  AutoComplete,
  Button,
  Checkbox,
  ...
  return (
    <>
      ...
      <ImportFieldDrawer
        ...
        onImport={(field) => {
          const fieldList = form.getFieldValue('fieldList') || [];
          fieldList.splice(importIndex, 0, field);
          form.setFieldValue('fieldList', fieldList);
