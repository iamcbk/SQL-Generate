...
import { CopyOutlined, DownloadOutlined, CodeOutlined, DatabaseOutlined } from '@ant-design/icons';
import {
  Button,
  Card,
  Collapse,
...
const GenerateResultCard: React.FC<Props> = (props) => {
  ...
  return showCard ? (
    <Card 
      ...
      loading={loading}
      className="generate-result-card"
      bordered={false}
    >
